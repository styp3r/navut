        ...
        <div id="navbar">
            ...
            <div id="navbarItems-mobile">
                ...
                <span id = "close-menu" onClick = {() => handleCloseMenu()} className="material-symbols-outlined">close</span>
                    <Link style={{ textDecoration: 'none' }} to="/"><p className="navbarLink-mobile">Home</p></Link>
                    <Link style={{ textDecoration: 'none' }} to="bookings-landing"><p className="navbarLink-mobile">Bookings</p></Link>
                    <Link style={{ textDecoration: 'none' }} to="about"><p className="navbarLink-mobile">About Us</p></Link>
                    <Link style={{ textDecoration: 'none' }} to="contact"><p className="navbarLink-mobile">Contact Us</p></Link>
                </div>
            </div>
